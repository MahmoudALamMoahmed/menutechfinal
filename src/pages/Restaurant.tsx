...
شكراً لكم.`;
  ...
  return <div className="min-h-screen bg-gray-50 pb-20" dir="rtl">
      ...
      <div className="relative bg-white h-48">
        {restaurant.cover_image_url && <img src={getCoverImageUrl(restaurant.cover_image_url)} alt={restaurant.name} className="w-full h-full object-cover container rounded-[40px] py-2" loading="eager" />}
